          ...
          <div className={useStyles.heroContent}>
            <Container maxWidth="sm">
              <div className={useStyles.heroButtons}>
                <Grid container spacing={2} justifyContent="center">
                  <Grid item>
                  <Button onClick={()=>this.handleClick("https://livesim.dashif.org/livesim/chunkdur_1/ato_7/testpic4_8s/Manifest300.mpd")} variant="contained" color="primary">
                    Canal 1
                  </Button>
                  </Grid>
                  <Grid item>
                  <Button onClick={()=>this.handleClick("http://streamer-1.dynavideo.com.br/channel2/bbb_movie.mpd")} variant="contained" color="primary">
                    Canal 2
                  </Button>
                  </Grid>
                  <Grid item>
                  <Button onClick={()=>this.handleClick("https://cmafref.akamaized.net/cmaf/live-ull/2006350/akambr/out.mpd")} variant="contained" color="primary">
                    Canal 3
                  </Button>
                  </Grid>
                  <Grid item>
